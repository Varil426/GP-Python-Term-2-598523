...
destitanion_lat, destitanion_lon, destitanion_city, destitanion_country = (
    check_coordinates(destitanion_city, API_KEY)
)
...
weather, temperature, pressure, humidity = get_weather_info(
    destitanion_lat, destitanion_lon
)
...
print(
    f"Jego współrzędne geograficzne to:\n{destitanion_lat} szerokości geograficznej \n{destitanion_lon} długości geograficznej"
)
